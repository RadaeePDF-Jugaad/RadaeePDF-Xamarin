...
namespace RadaeeLib {
	...
	[ProtocolMember (IsRequired = true, IsProperty = false, IsStatic = false, Name = "DidDoubleTapOnPage", Selector = "didDoubleTapOnPage:atPoint:", ParameterType = new Type [] { typeof (int), typeof (CGPoint) }, ParameterByRef = new bool [] { false, false })]
	[ProtocolMember (IsRequired = true, IsProperty = false, IsStatic = false, Name = "DidLongPressOnPage", Selector = "didLongPressOnPage:atPoint:", ParameterType = new Type [] { typeof (int), typeof (CGPoint) }, ParameterByRef = new bool [] { false, false })]
	...
	internal sealed class RadaeePDFPluginDelegateWrapper : BaseWrapper, IRadaeePDFPluginDelegate {
		...
		[Export ("didDoubleTapOnPage:atPoint:")]
		[CompilerGenerated]
		public void DidDoubleTapOnPage (int page, CGPoint point)
		{
			global::ApiDefinition.Messaging.void_objc_msgSend_int_CGPoint (this.Handle, Selector.GetHandle ("didDoubleTapOnPage:atPoint:"), page, point);
		}
		
		[Export ("didLongPressOnPage:atPoint:")]
		[CompilerGenerated]
		public void DidLongPressOnPage (int page, CGPoint point)
		{
			global::ApiDefinition.Messaging.void_objc_msgSend_int_CGPoint (this.Handle, Selector.GetHandle ("didLongPressOnPage:atPoint:"), page, point);
		}
...
namespace RadaeeLib {
	...
	public unsafe abstract partial class RadaeePDFPluginDelegate : NSObject, IRadaeePDFPluginDelegate {
		...
		[Export ("didDoubleTapOnPage:atPoint:")]
		[CompilerGenerated]
		public abstract void DidDoubleTapOnPage (int page, CGPoint point);
		[Export ("didLongPressOnPage:atPoint:")]
		[CompilerGenerated]
		public abstract void DidLongPressOnPage (int page, CGPoint point);
		[Export ("didSearchTerm:found:")]
		[CompilerGenerated]
