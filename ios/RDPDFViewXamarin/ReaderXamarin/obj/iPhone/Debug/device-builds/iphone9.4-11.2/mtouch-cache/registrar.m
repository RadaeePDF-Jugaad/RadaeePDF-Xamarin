...
@implementation __UIRotationGestureRecognizer {
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_18 (self, _cmd, &managed_method, p0, 0x3F704);
	}
@end
...
@implementation __UITapGestureRecognizer {
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_19 (self, _cmd, &managed_method, p0, 0x3FB04);
	}
@end
...
@implementation __UIPinchGestureRecognizer {
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_20 (self, _cmd, &managed_method, p0, 0x3FF04);
	}
@end
...
@implementation __UISwipeGestureRecognizer {
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_21 (self, _cmd, &managed_method, p0, 0x40304);
	}
@end
...
@implementation __UIScreenEdgePanGestureRecognizer {
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_22 (self, _cmd, &managed_method, p0, 0x40704);
	}
@end
