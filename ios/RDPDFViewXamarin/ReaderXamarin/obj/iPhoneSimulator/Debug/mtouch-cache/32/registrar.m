...
@implementation UIApplicationDelegate {
	...
	-(id) init
	{
		...
		id rv = native_to_managed_trampoline_1 (self, _cmd, &managed_method, &call_super, 0x1A904);
		if (call_super && rv) {
...
@implementation UIKit_UIControlEventProxy {
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_2 (self, _cmd, &managed_method, 0x18104);
	}

	-(BOOL) conformsToProtocol:(void *)p0
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_3 (self, _cmd, &managed_method, p0, 0x22A04);
	}
@end
...
@implementation Foundation_NSDispatcher {
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_2 (self, _cmd, &managed_method, 0x20804);
	}
	...
	-(id) init
	{
		static MonoMethod *managed_method = NULL;
		bool call_super = false;
		id rv = native_to_managed_trampoline_1 (self, _cmd, &managed_method, &call_super, 0x20704);
		if (call_super && rv) {
			struct objc_super super = {  rv, [NSObject class] };
			rv = ((id (*)(objc_super*, SEL)) objc_msgSendSuper) (&super, @selector (init));
		}
...
@implementation __MonoMac_NSSynchronizationContextDispatcher {
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_2 (self, _cmd, &managed_method, 0x20B04);
	}
@end
...
@implementation Foundation_NSAsyncDispatcher {
	...
	-(id) init
	{
		static MonoMethod *managed_method = NULL;
		bool call_super = false;
		id rv = native_to_managed_trampoline_1 (self, _cmd, &managed_method, &call_super, 0x20C04);
		if (call_super && rv) {
...
#pragma clang diagnostic ignored "-Wobjc-protocol-property-synthesis"
#pragma clang diagnostic ignored "-Wobjc-property-implementation"
@implementation RadaeePDFPluginDelegate {
}
...
@implementation ViewController {
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_2 (self, _cmd, &managed_method, 0x1700);
	}

	-(void) didReceiveMemoryWarning
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_2 (self, _cmd, &managed_method, 0x1800);
	}
...
@implementation __NSObject_Disposer {
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_14 (self, _cmd, &managed_method, p0, 0x25104);
	}
	...
	-(id) init
	{
		static MonoMethod *managed_method = NULL;
		bool call_super = false;
		id rv = native_to_managed_trampoline_1 (self, _cmd, &managed_method, &call_super, 0x24F04);
		if (call_super && rv) {
			struct objc_super super = {  rv, [NSObject class] };
			rv = ((id (*)(objc_super*, SEL)) objc_msgSendSuper) (&super, @selector (init));
		}
...
void xamarin_create_classes () {
	...
	__xamarin_class_map [5].handle = objc_getClass ("UIAlertView");
	...
	__xamarin_class_map [12].handle = objc_getClass ("UINavigationBar");
	...
	__xamarin_class_map [26].handle = objc_getClass ("NSData");
	__xamarin_class_map [27].handle = objc_getClass ("NSDictionary");
	__xamarin_class_map [28].handle = [AppDelegate class];
	__xamarin_class_map [29].handle = [RadaeePDFPluginDelegate class];
	__xamarin_class_map [30].handle = [ReaderXamarin_RadaeeDelegate class];
	__xamarin_class_map [31].handle = [ViewController class];
	__xamarin_class_map [32].handle = objc_getClass ("__NSObject_Disposer");
	__xamarin_class_map [33].handle = [RadaeePDFPlugin class];
