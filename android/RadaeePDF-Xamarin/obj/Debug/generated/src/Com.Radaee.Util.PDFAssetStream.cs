...
namespace Com.Radaee.Util {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.radaee.util']/class[@name='PDFAssetStream']"
	[global::Android.Runtime.Register ("com/radaee/util/PDFAssetStream", DoNotGenerateAcw=true)]
	public partial class PDFAssetStream : global::Java.Lang.Object, global::Com.Radaee.Pdf.Document.IPDFStream {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/radaee/util/PDFAssetStream", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (PDFAssetStream); }
		}

		protected PDFAssetStream (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.radaee.util']/class[@name='PDFAssetStream']/constructor[@name='PDFAssetStream' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe PDFAssetStream ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (PDFAssetStream)) {
					SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::Com.Radaee.Util.PDFAssetStream __this = global::Java.Lang.Object.GetObject<global::Com.Radaee.Util.PDFAssetStream> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			__this.Close ();
		}
#pragma warning restore 0169

		static IntPtr id_close;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.radaee.util']/class[@name='PDFAssetStream']/method[@name='close' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.radaee.util']/class[@name='PDFAssetStream']/method[@name='get_size' and count(parameter)=0]"
		...
		static Delegate cb_open_Landroid_content_res_AssetManager_Ljava_lang_String_;
#pragma warning disable 0169
		static Delegate GetOpen_Landroid_content_res_AssetManager_Ljava_lang_String_Handler ()
		{
			if (cb_open_Landroid_content_res_AssetManager_Ljava_lang_String_ == null)
				cb_open_Landroid_content_res_AssetManager_Ljava_lang_String_ = JNINativeWrapper.CreateDelegate ((Func<IntPtr, IntPtr, IntPtr, IntPtr, bool>) n_Open_Landroid_content_res_AssetManager_Ljava_lang_String_);
			return cb_open_Landroid_content_res_AssetManager_Ljava_lang_String_;
		}

		static bool n_Open_Landroid_content_res_AssetManager_Ljava_lang_String_ (IntPtr jnienv, IntPtr native__this, IntPtr native_p0, IntPtr native_p1)
		{
			global::Com.Radaee.Util.PDFAssetStream __this = global::Java.Lang.Object.GetObject<global::Com.Radaee.Util.PDFAssetStream> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		static IntPtr id_open_Landroid_content_res_AssetManager_Ljava_lang_String_;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.radaee.util']/class[@name='PDFAssetStream']/method[@name='open' and count(parameter)=2 and parameter[1][@type='android.content.res.AssetManager'] and parameter[2][@type='java.lang.String']]"
		[Register ("open", "(Landroid/content/res/AssetManager;Ljava/lang/String;)Z", "GetOpen_Landroid_content_res_AssetManager_Ljava_lang_String_Handler")]
		public virtual unsafe bool Open (global::Android.Content.Res.AssetManager p0, string p1)
		{
			if (id_open_Landroid_content_res_AssetManager_Ljava_lang_String_ == IntPtr.Zero)
				id_open_Landroid_content_res_AssetManager_Ljava_lang_String_ = JNIEnv.GetMethodID (class_ref, "open", "(Landroid/content/res/AssetManager;Ljava/lang/String;)Z");
			...
			try {
				...
				bool __ret;
				if (((object) this).GetType () == ThresholdType)
					__ret = JNIEnv.CallBooleanMethod (((global::Java.Lang.Object) this).Handle, id_open_Landroid_content_res_AssetManager_Ljava_lang_String_, __args);
				else
					__ret = JNIEnv.CallNonvirtualBooleanMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "open", "(Landroid/content/res/AssetManager;Ljava/lang/String;)Z"), __args);
				return __ret;
			} finally {
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.radaee.util']/class[@name='PDFAssetStream']/method[@name='read' and count(parameter)=1 and parameter[1][@type='byte[]']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.radaee.util']/class[@name='PDFAssetStream']/method[@name='seek' and count(parameter)=1 and parameter[1][@type='int']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.radaee.util']/class[@name='PDFAssetStream']/method[@name='tell' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.radaee.util']/class[@name='PDFAssetStream']/method[@name='write' and count(parameter)=1 and parameter[1][@type='byte[]']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.radaee.util']/class[@name='PDFAssetStream']/method[@name='writeable' and count(parameter)=0]"
