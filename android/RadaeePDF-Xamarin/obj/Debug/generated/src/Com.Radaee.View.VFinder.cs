...
namespace Com.Radaee.View {
	...
	public partial class VFinder : global::Java.Lang.Object {
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (VFinder)) {
					SetHandle (
...
#pragma warning restore 0169
		...
		protected virtual unsafe void Find_draw (global::Android.Graphics.Canvas p0, global::Com.Radaee.View.VPage p1, int p2, int p3)
		{
			...
			try {
				...
				if (((object) this).GetType () == ThresholdType)
					JNIEnv.CallVoidMethod (((global::Java.Lang.Object) this).Handle, id_find_draw_Landroid_graphics_Canvas_Lcom_radaee_view_VPage_II, __args);
				else
					JNIEnv.CallNonvirtualVoidMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "find_draw", "(Landroid/graphics/Canvas;Lcom/radaee/view/VPage;II)V"), __args);
			} finally {
			}
		}
