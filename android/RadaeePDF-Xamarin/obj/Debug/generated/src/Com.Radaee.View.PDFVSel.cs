...
namespace Com.Radaee.View {
	...
	public partial class PDFVSel : global::Java.Lang.Object {
		...
		protected unsafe PDFVSel (global::Com.Radaee.Pdf.Page p0)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (((object) this).GetType () != typeof (PDFVSel)) {
					SetHandle (
...
#pragma warning restore 0169
		...
		protected virtual unsafe string SelString {
...
#pragma warning restore 0169
		...
		protected virtual unsafe void DrawSel (global::Android.Graphics.Canvas p0, float p1, float p2, int p3, int p4)
		{
...
#pragma warning restore 0169
		...
		protected virtual unsafe void DrawSel (global::Com.Radaee.Pdf.BMP p0, float p1, float p2, int p3, int p4)
		{
			...
			try {
				...
				if (((object) this).GetType () == ThresholdType)
					JNIEnv.CallVoidMethod (((global::Java.Lang.Object) this).Handle, id_DrawSel_Lcom_radaee_pdf_BMP_FFII, __args);
				else
					JNIEnv.CallNonvirtualVoidMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "DrawSel", "(Lcom/radaee/pdf/BMP;FFII)V"), __args);
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		protected virtual unsafe void DrawSelToDIB (global::Com.Radaee.Pdf.DIB p0, float p1, float p2, int p3, int p4)
		{
			...
			try {
				...
				if (((object) this).GetType () == ThresholdType)
					JNIEnv.CallVoidMethod (((global::Java.Lang.Object) this).Handle, id_DrawSelToDIB_Lcom_radaee_pdf_DIB_FFII, __args);
				else
					JNIEnv.CallNonvirtualVoidMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "DrawSelToDIB", "(Lcom/radaee/pdf/DIB;FFII)V"), __args);
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		protected virtual unsafe int[] GetRect1 (float p0, float p1, int p2, int p3)
		{
...
#pragma warning restore 0169
		...
		protected virtual unsafe int[] GetRect2 (float p0, float p1, int p2, int p3)
		{
...
#pragma warning restore 0169
		...
		protected virtual unsafe void SetSel (float p0, float p1, float p2, float p3)
		{
...
#pragma warning restore 0169
		...
		protected virtual unsafe bool SetSelMarkup (int p0)
		{
