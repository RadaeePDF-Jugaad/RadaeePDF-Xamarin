...
namespace Com.Radaee.Util {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.radaee.util']/class[@name='PDFMemStream']"
	[global::Android.Runtime.Register ("com/radaee/util/PDFMemStream", DoNotGenerateAcw=true)]
	public partial class PDFMemStream : global::Java.Lang.Object, global::Com.Radaee.Pdf.Document.IPDFStream {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/radaee/util/PDFMemStream", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (PDFMemStream); }
		}

		protected PDFMemStream (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_arrayB;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.radaee.util']/class[@name='PDFMemStream']/constructor[@name='PDFMemStream' and count(parameter)=1 and parameter[1][@type='byte[]']]"
		[Register (".ctor", "([B)V", "")]
		public unsafe PDFMemStream (byte[] p0)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (((object) this).GetType () != typeof (PDFMemStream)) {
					SetHandle (
		...
		static Delegate cb_get_data;
#pragma warning disable 0169
		static Delegate GetGet_dataHandler ()
		{
			if (cb_get_data == null)
				cb_get_data = JNINativeWrapper.CreateDelegate ((Func<IntPtr, IntPtr, IntPtr>) n_Get_data);
			return cb_get_data;
		}

		static IntPtr n_Get_data (IntPtr jnienv, IntPtr native__this)
		{
			global::Com.Radaee.Util.PDFMemStream __this = global::Java.Lang.Object.GetObject<global::Com.Radaee.Util.PDFMemStream> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			return JNIEnv.NewArray (__this.Get_data ());
		}
#pragma warning restore 0169

		static IntPtr id_get_data;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.radaee.util']/class[@name='PDFMemStream']/method[@name='get_data' and count(parameter)=0]"
		[Register ("get_data", "()[B", "GetGet_dataHandler")]
		public virtual unsafe byte[] Get_data ()
		{
			if (id_get_data == IntPtr.Zero)
				id_get_data = JNIEnv.GetMethodID (class_ref, "get_data", "()[B");
			try {

				if (((object) this).GetType () == ThresholdType)
					return (byte[]) JNIEnv.GetArray (JNIEnv.CallObjectMethod (((global::Java.Lang.Object) this).Handle, id_get_data), JniHandleOwnership.TransferLocalRef, typeof (byte));
				else
					return (byte[]) JNIEnv.GetArray (JNIEnv.CallNonvirtualObjectMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "get_data", "()[B")), JniHandleOwnership.TransferLocalRef, typeof (byte));
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.radaee.util']/class[@name='PDFMemStream']/method[@name='get_size' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.radaee.util']/class[@name='PDFMemStream']/method[@name='read' and count(parameter)=1 and parameter[1][@type='byte[]']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.radaee.util']/class[@name='PDFMemStream']/method[@name='seek' and count(parameter)=1 and parameter[1][@type='int']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.radaee.util']/class[@name='PDFMemStream']/method[@name='tell' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.radaee.util']/class[@name='PDFMemStream']/method[@name='write' and count(parameter)=1 and parameter[1][@type='byte[]']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.radaee.util']/class[@name='PDFMemStream']/method[@name='writeable' and count(parameter)=0]"
